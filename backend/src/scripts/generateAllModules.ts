...
const RECREATED_FREE: ModuleSpec[] = [
  {
    id: 'saving',
...
const RECREATED_PRO: ModuleSpec[] = [
  {
...
async function main() {
  ...
  const doneIds = new Set(modules.map((m: any) => m.id));
