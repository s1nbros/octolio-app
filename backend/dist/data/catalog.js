...
exports.LESSONS_PER_CHEST = exports.MIN_XP_EXCHANGE = exports.XP_PER_COIN_EXCHANGE_RATE = exports.CATALOG = void 0;
exports.getCatalogItem = getCatalogItem;
exports.drawReward = drawReward;
exports.CATALOG = [
    // ── HAT slot ──
...
exports.MIN_XP_EXCHANGE = 100; // floor on a single tx
/** How many chests the user has earned in total (1 per 3 lessons completed). */
exports.LESSONS_PER_CHEST = 3;
