...
exports.WORKOUT_REWARD_WRONG = exports.WORKOUT_REWARD_CORRECT = exports.WORKOUTS = void 0;
...
function getTodaysWorkout(today = new Date()) {
    const index = dayNumberUTC(today) % exports.WORKOUTS.length;
    return { index, question: exports.WORKOUTS[index] };
}
/** Reward tuning. */
exports.WORKOUT_REWARD_CORRECT = { xp: 15, coins: 5 };
exports.WORKOUT_REWARD_WRONG = { xp: 5, coins: 0 };
